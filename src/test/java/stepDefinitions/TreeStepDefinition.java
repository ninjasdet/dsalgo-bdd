...
public class TreeStepDefinition {
	...
	public void for_tree_the_user_clicks_the_run_button_after_entering_from(Integer int1, String string) {
	...
	public void the_user_should_be_redirected_to_overview_of_trees_page() {
		Assert.assertTrue(loginPage.getCurrentUrl().contains("overview-of-trees"), "Page is not navigated to Overview of Trees page ");
	}
	...
	public void the_user_should_be_redirected_to_terminologies_page() {
		Assert.assertTrue(loginPage.getCurrentUrl().contains("terminologies"), "Page is not navigated to tryeditorpage");
	}
	...
	public void the_user_should_be_redirected_to_types_of_trees_page() {
		Assert.assertTrue(loginPage.getCurrentUrl().contains("types-of-trees"), "page is not navigating back to the types of tree page");
	}
	...
	public void the_user_should_be_redirected_to_tree_traversals_page() {
		Assert.assertTrue(loginPage.getCurrentUrl().contains("tree-traversals"), "page is not navigating back to tree traversals page");
	}
	...
	public void the_user_should_be_redirected_to_traversals_illustration_page() {
		Assert.assertTrue(loginPage.getCurrentUrl().contains("traversals-illustration"), "page is not navigated to traversal illustration");
	}
	...
	public void the_user_should_be_redirected_to_binary_trees_page() {
		Assert.assertTrue(loginPage.getCurrentUrl().contains("binary-trees"), "page is not navigated back to binarytrees page");
	}
	...
	public void the_user_should_be_redirected_to_the_tree_page() {
		Assert.assertTrue(loginPage.getCurrentUrl().contains("overview-of-trees"), "page is not navigated back to overviewof tree page");
	}
