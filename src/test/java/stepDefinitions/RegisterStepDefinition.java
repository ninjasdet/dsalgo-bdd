...
public class RegisterStepDefinition {
	...
	@Then("The user should able to see error {string} appears below Username textbox")
	public void the_user_should_able_to_see_error_appears_below_username_textbox(String string) {
		// Write code here that turns the phrase above into concrete actions
		throw new io.cucumber.java.PendingException();
	}
	...
	@When("The user clicks Register button after entering password and leaving Username with  field empty")
	public void the_user_clicks_register_button_after_entering_password_and_leaving_username_with_field_empty() {
		// Write code here that turns the phrase above into concrete actions
		throw new io.cucumber.java.PendingException();
	}
	...
	@When("The user clicks Register button after entering same information in Username and Password fields.")
	public void the_user_clicks_register_button_after_entering_same_information_in_username_and_password_fields() {
		// Write code here that turns the phrase above into concrete actions
		throw new io.cucumber.java.PendingException();
	}
	...
	public void the_user_clicks_button_after_entering_different_passwords_in_password_and_password_confirmation_fields(
			String string) {
		// Write code here that turns the phrase above into concrete actions
		throw new io.cucumber.java.PendingException();
	}

	@When("The user clicks {string} button after entering password without lessthan {int} characters.")
	public void the_user_clicks_button_after_entering_password_without_lessthan_characters(String string,
			Integer int1) {
		// Write code here that turns the phrase above into concrete actions
		throw new io.cucumber.java.PendingException();
	}

	@When("The user clicks {string} button after entering password entirely with numeric.")
	public void the_user_clicks_button_after_entering_password_entirely_with_numeric(String string) {
		// Write code here that turns the phrase above into concrete actions
		throw new io.cucumber.java.PendingException();
	}
	...
	//manuall
	public void the_user_clicks_register_button_after_entering_and(Integer int1, String string) {
	    // Write code here that turns the phrase above into concrete actions
		common.the_user_clicks_the_run_button_after_entering_from(int1, string);
	}
